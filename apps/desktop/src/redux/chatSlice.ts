// desktop/src/redux/chatSlice.ts
...
const initialState: ChatState = { rooms: [], messages: {}, activeRoomId: null, isLoading: false };
...
export const { addMessage, setActiveRoom } = chatSlice.actions;
